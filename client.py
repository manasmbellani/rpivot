...
class SocksRelay(object):
    ...
    def run(self):
        ...
        while True:
            ...
            try:
                ...
                self.shutdown()
            except select.error as xxx_todo_changeme1:
                ...
                (code, msg) = xxx_todo_changeme2.args
            ...
            for sock in outputready:
                ...
                try:
                    ...
                    (code, err_msg) = xxx_todo_changeme.args
    ...
    def get_channel_data(self, sock):
        ...
        except socket.error as xxx_todo_changeme4:
            (code, msg) = xxx_todo_changeme4.args
    ...
    def manage_forward_socket(self, sock):
        ...
        except socket.error as xxx_todo_changeme5:
            (code, msg) = xxx_todo_changeme5.args
    ...
    def send_remote_cmd(self, sock, cmd, *args):
        ...
        except socket.error as xxx_todo_changeme6:
            (code, cmd) = xxx_todo_changeme6.args
    ...
    def establish_forward_socket(self, channel_id, host, port):
        ...
        except socket.error as xxx_todo_changeme7:
            (code, msg) = xxx_todo_changeme7.args
    ...
    def relay(self, data, to_socket):
        ...
        try:
            to_socket.send(data)
        except socket.error as xxx_todo_changeme8:
            (code, msg) = xxx_todo_changeme8.args
...
'''
    ...
    def connect(self, host_port):
        ...
        except socket.error as xxx_todo_changeme9:
            (code, msg) = xxx_todo_changeme9.args
        ...
        try:
            ...
            resp = self._sock.recv(4096)
        except socket.error as xxx_todo_changeme10:
            (code, msg) = xxx_todo_changeme10.args
    ...
    while True:
        ...
        while True:
            try:
                ...
                (code, msg) = xxx_todo_changeme3.args
        ...
        try:
            ...
            if banner_reponse_rcv != relay.banner_response:
                ...
                time.sleep(5)
                continue
        except socket.error as xxx_todo_changeme11:
            (code, msg) = xxx_todo_changeme11.args
        ...
        try:
            socks_relayer.run()
        except socket.error as xxx_todo_changeme12:
            (code, msg) = xxx_todo_changeme12.args
